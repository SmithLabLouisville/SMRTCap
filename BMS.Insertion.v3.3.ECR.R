...
lapply(package_names, library, character.only = TRUE)
  ...
  REF_SIZE_DIR <-  "/home/stnada01/scripts/sizeReferences/" #E:\\SMRTCap\\"
  coordinateDir <- "/home/stnada01/scripts/hg38/"
  ...
  ADD_CHR_FLAG = FALSE      ## True to add chr to chromosome names; False to keep as normal
